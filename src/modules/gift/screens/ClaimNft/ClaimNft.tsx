  ...
  return (
    <Box className={styles.root}>
      <GiftHeader
        ...
        description={`Please claim your NFT by Saturday, December 18 @ 9 p.m. ET/6 p.m. PT. Otherwise your password will be expired. 
Check your NFT on fangible.com - [My Profile] - [Showcase]`}
      />
