  ...
  return (
    <Box className={styles.root}>
      <GiftHeader
        ...
        description={
          'Passwords are enclosed in gift boxes. Please claim your NFT by Saturday, December 18 @ 9pm ET/6pm PT - password will expire then and all unclaimed NFTs will be available for event guests to claim.'
        }
      />
